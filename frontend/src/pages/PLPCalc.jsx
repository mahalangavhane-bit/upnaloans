...
const banks = [
  { name: "HDFC Bank", logo: "HDFC", rate: "10.50%", min: "10.75%", amount: "Rs.40L", color: "#004C8F", processing: "1%", tenure: "1-5 yrs", prepayment: "Nil after 12 months" },
  { name: "ICICI Bank", logo: "ICICI", rate: "10.75%", min: "10.75%", amount: "Rs.40L", color: "#F07D00", processing: "2%", tenure: "1-6 yrs", prepayment: "5% before 24 months" },
  { name: "SBI", logo: "SBI", rate: "11.00%", min: "11.00%", amount: "Rs.20L", color: "#22488C", processing: "1.5%", tenure: "1-6 yrs", prepayment: "3% before 36 months" },
  { name: "Bajaj Finserv", logo: "BAJAJ", rate: "11.99%", min: "11.99%", amount: "Rs.35L", color: "#1E3A5F", processing: "3.93%", tenure: "1-8 yrs", prepayment: "4% before 24 months" },
];

const faqs = [
  { q: "What is Personal Loan Prepayment?", a: "Personal loan prepayment is the act of paying off your loan partially or fully before the scheduled tenure ends. This helps reduce the total interest burden and can lead to significant savings." },
  { q: "How does prepayment affect my loan?", a: "Prepayment reduces your outstanding principal, which in turn reduces future interest calculations. This can either lower your EMI (if tenure remains same) or shorten your loan tenure (if EMI remains same)." },
  { q: "Are there prepayment charges?", a: "Most banks charge prepayment penalties, typically 2-5% of the prepaid amount, especially during the first 12-24 months. Some banks waive these charges after a certain period or for floating rate loans." },
  { q: "Should I reduce EMI or tenure?", a: "Reducing tenure is generally better as it saves more total interest. However, reducing EMI provides monthly cash flow relief. Choose based on your financial goals and cash flow needs." },
  { q: "Is the UpnaLoan prepayment calculator accurate?", a: "Yes. Our calculator uses standard banking formulas and considers prepayment charges to give you accurate savings estimates. Results help you make informed prepayment decisions." },
];
...
export default function PLPCalc() {
  ...
  const [prepaymentCharge, setPrepaymentCharge] = useState(3);
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "clamp(32px, 6vw, 48px) clamp(16px, 5vw, 48px)" }}>
        ...
        <div style={{ display: "flex", gap: "clamp(24px, 4vw, 40px)", marginTop: 20, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 380px", ...card }}>
            ...
            <SliderInput label="Prepayment Amount" value={prepaymentAmount} min={10000} max={loanAmount} step={10000}
            ...
            <div style={{ background: "#eff6ff", borderRadius: 12, padding: "14px 18px", marginTop: 20, border: "1px solid #bfdbfe", display: "flex", alignItems: "flex-start", gap: 8 }}>
              ...
              <p style={{ margin: 0, fontSize: 12, color: "#3b82f6", lineHeight: 1.6 }}>
                <strong>Tip:</strong> Many banks waive prepayment charges after 12 months. Check with your lender for exact terms.
              </p>
            </div>
          </div>
            ...
            <div style={{ ...card }}>
              ...
              <div style={{ display: "grid", gap: 12 }}>
                {[
                  ...
                  [`${prepaymentCharge}%`, "Prepayment Charges"]
                ].map(([value, label]) => (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "clamp(16px, 3vw, 24px)" }}>
            {banks.map((b, i) => (
              <div key={i} style={{
                ...
                {i === 0 && <div style={{ position: "absolute", top: -1, right: 20, background: "#16a34a", color: "#fff", fontSize: 10, fontWeight: 700, padding: "3px 10px", borderRadius: "0 0 8px 8px" }}>LOWEST CHARGES</div>}
