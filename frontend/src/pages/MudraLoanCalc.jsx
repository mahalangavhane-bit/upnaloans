    ...
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h1 style={{ 
            ...
            letterSpacing: "-0.5px" 
              ...
              <span style={{color:"#111827"}}>Mudra Loan{" "}</span>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "clamp(32px, 6vw, 48px) clamp(16px, 5vw, 48px)" }}>
          ...
          <div style={{ flex: "1 1 380px", ...card }}>
            ...
            <div style={{ background: "#eff6ff", borderRadius: 12, padding: "14px 18px", marginTop: 8, border: "1px solid #bfdbfe", display: "flex", alignItems: "flex-start", gap: 8 }}>
              ...
              <p style={{ margin: 0, fontSize: 12, color: "#3b82f6", lineHeight: 1.6 }}>
                <strong>Tip:</strong> Mudra loans are government-backed. Check your eligibility before applying.
              </p>
            </div>
          </div>
              ...
              <div key={i} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "#94a3b8" }}>Mudra Loan</div>
                  </div>
                </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "clamp(20px, 4vw, 32px)", marginTop: 48 }}>
          {[
            ["What is a Mudra Loan?", "Mudra Loan is a government-backed scheme offering loans up to ₹10 lakh to micro and small enterprises. It has three categories: Shishu (up to ₹50,000), Kishor (₹50,001 to ₹5 lakh), and Tarun (₹5 lakh to ₹10 lakh)."],
            ["What is a Mudra Loan EMI?", "EMI stands for Equated Monthly Installment — a fixed monthly payment comprising principal repayment and interest. It helps borrowers plan structured repayments over a chosen tenure, making loan management predictable."],
            ...
            ["Eligibility for Mudra Loan?", "Any Indian citizen with a business plan, existing micro/small enterprise, or individual engaged in income-generating activities can apply. No collateral required. Credit score above 650 is preferred."],
            ["Documents Required", "KYC documents (Aadhar/PAN/Voter ID), business proof, bank statements (last 6 months), income proof, and business continuity proof are typically required for Mudra loan application."],
            ["Why Use Our Calculator?", "Instant results, accurate calculations based on RBI guidelines, compare multiple lenders, understand your borrowing capacity before applying for a Mudra loan."],
          ].map(([title, body]) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "clamp(20px, 4vw, 32px)", marginTop: 48 }}>
          {[
            ["What Impacts Your Mudra Loan EMI?", [
            ...
            ["How to Reduce Your Mudra Loan EMI?", [
        ...
        <div style={{
          ...
          <div>
            <h2 style={{ fontSize: "clamp(20px, 5vw, 26px)", fontWeight: 800, color: "#fff", margin: "0 0 8px" }}>Need a Mudra Loan for Your Business?</h2>
            <p style={{ color: "rgba(255,255,255,0.75)", margin: 0, fontSize: "clamp(13px, 4vw, 15px)" }}>Government-backed · Low interest rates · Quick approval · No collateral required</p>
          </div>
