    ...
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
        ...
        <div style={{
          ...
          <div>
            <h2 style={{ fontSize: 26, fontWeight: 800, color: "#fff", margin: "0 0 8px" }}>Need a Business Loan?</h2>
            <p style={{ color: "rgba(255,255,255,0.75)", margin: 0, fontSize: 15 }}>Lowest rates · Instant approval · 100% digital process · Zero hidden charges</p>
          </div>
