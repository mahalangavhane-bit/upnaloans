...
const banks = [
  ...
  { name: "ICICI Bank", logo: "ICICI", rate: "10.75%", min: "10.75%", amount: "₹40L", color: "#F07D00", processing: "2%", tenure: "1-6 yrs" },
...
const faqs = [
  { q: "What is a Business Loan EMI?", a: "A Business Loan EMI (Equated Monthly Installment) is the fixed monthly payment you make to repay your business loan principal along with applicable interest over a chosen tenure. It remains constant throughout the loan period." },
  { q: "How is Business Loan EMI calculated?", a: "EMI is calculated using the formula: EMI = [P × r × (1+r)^n] / [(1+r)^n – 1], where P = Principal amount, r = monthly interest rate, and n = total number of months." },
  { q: "What factors affect my Business Loan EMI?", a: "Your Business Loan EMI is primarily affected by three factors: loan amount borrowed, interest rate charged by the lender, and repayment tenure you select. A higher loan amount or rate increases EMI, while a longer tenure reduces it." },
  { q: "Can I reduce my Business Loan EMI?", a: "Yes — you can reduce your EMI by opting for a longer repayment tenure, maintaining a high credit score to negotiate lower interest rates, making partial prepayments to reduce principal, or refinancing with a lender offering better rates." },
  { q: "Is UpnaLoan Business Loan EMI calculator accurate?", a: "Yes. Our calculator uses the standard reducing balance formula used by all RBI-regulated banks and NBFCs in India. Results are accurate to the rupee for parameters you enter." },
];
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", background: "#f8fafc", minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h1 style={{ 
            ...
            <span style={{color: "#111827"}}>
              ...
              <span style={{color:"#f97316"}}>EMI Calculator
              </span>
          </h1>
          <p style={{ color: "#94a3b8", fontSize: "clamp(14px, 4vw, 16px)", lineHeight: 1.7, maxWidth: 580, margin: "0 0 24px" }}>
            Calculate your monthly EMI instantly across India's top lenders. Compare rates, plan your budget, and apply for the best business loan offer in seconds.
          </p>
          <div style={{ display: "flex", gap: "clamp(16px, 4vw, 28px)", flexWrap: "wrap" }}>
            {[["₹50 Lakh", "Max Loan Amount"], ["12.50%", "Starting Interest Rate"], ["60 Months", "Max Tenure"], ["2 Min", "Instant Approval"]].map(([val, lbl]) => (
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #f1f5f9", padding: "10px clamp(16px, 5vw, 48px)" }}>
        ...
        <span style={{ fontSize: 12, color: "#94a3b8" }}>Business Loan</span>
        <span style={{ fontSize: 12, color: "#cbd5e1", margin: "0 6px" }}>›</span>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "clamp(32px, 6vw, 48px) clamp(16px, 5vw, 48px)" }}>
        ...
        <div style={{ display: "flex", gap: "clamp(24px, 4vw, 40px)", marginTop: 20, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 380px", ...card }}>
            ...
            <SliderInput label="Loan Amount" value={loanAmount} min={100000} max={50000000} step={100000}
              onChange={setLoanAmount} prefix="₹" formatFn={v => formatINR(v)} />
            <SliderInput label="Rate of Interest (p.a.)" value={interestRate} min={8} max={24} step={0.25}
        ...
        {/* AMORTIZATION TABLE */}
        <div style={{ ...card, marginTop: 48, overflow: "hidden" }}>
        ...
        <div style={{ marginTop: 48 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
            <div>
              <h2 style={{ fontSize: "clamp(20px, 5vw, 22px)", fontWeight: 800, color: "#1e293b", margin: 0 }}>Current Bank Offers</h2>
              ...
              <div key={i} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "#94a3b8" }}>Business Loan</div>
                  </div>
                </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "clamp(20px, 4vw, 32px)", marginTop: 48 }}>
          {[
            ["What is a Business Loan EMI?", "EMI stands for Equated Monthly Installment — a fixed monthly payment comprising principal repayment and interest. It helps borrowers plan structured repayments over a chosen tenure, making loan management predictable and hassle-free."],
            ["What is a Business Loan EMI Calculator?", "A business loan EMI calculator is a free online tool that instantly estimates your monthly installment based on your loan amount, interest rate, and tenure. It removes manual calculation errors and saves significant time."],
            ...
            ["Compare EMIs Across Banks & NBFCs", "Different lenders offer varying rates. HDFC starts at 10.50%, ICICI at 10.75%, SBI at 11.00%, and Bajaj Finserv at 11.99%. Using our calculator helps you identify the most cost-effective lender before applying."],
          ].map(([title, body]) => (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "clamp(20px, 4vw, 32px)", marginTop: 48 }}>
          {[
            ["What Impacts Your Business Loan EMI?", [
        ...
        <div style={{
          ...
          <div>
            <h2 style={{ fontSize: "clamp(20px, 5vw, 26px)", fontWeight: 800, color: "#fff", margin: "0 0 8px" }}>Need a Business Loan?</h2>
            <p style={{ color: "rgba(255,255,255,0.75)", margin: 0, fontSize: "clamp(13px, 4vw, 15px)" }}>Lowest rates · Instant approval · 100% digital process · Zero hidden charges</p>
          </div>
